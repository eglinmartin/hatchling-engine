...
---@param depth         number      Draw order depth (255 highest, 0 lowest)
---@param align         string      Alignment of text - left, centre or right
function Engine:add_text_hud(text_id, string, font, colour, x, y, scale, rot, depth, align)
    self.render_manager:create_text_hud_object(text_id, string, font, colour, x, y, scale, rot, depth, align)
end
...
---@param rot           number  Angle of rotation in degrees
---@param depth         number  Draw order depth (255 highest, 0 lowest)
function Engine:add_sprite_hud(sprite_id, sprite_name, sprite_tag, x, y, scale, rot, depth)
    self.render_manager:create_draw_object_hud(sprite_id, sprite_name, sprite_tag, x, y, rot, scale, depth)
end
...
---@param rot               number  Angle of rotation in degrees
---@param depth             number  Draw order depth (255 highest, 0 lowest)
function Engine:add_sprite_background(background_id, background_name, background_tag, x, y, scale, rot, depth)
